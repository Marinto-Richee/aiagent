...
## THEORY
A vacuum-cleaner world with 9 locations.
<br/>Each location can be clean or dirty.
<br/>The agent can move left, right, up, down,and can clean the square that it occupies.
...
## DESIGN STEPS
### STEP 1:
The AI agent will have the location input, to interpert its location in the environment, and cleanliness sensor, to sense if the given location is clean or not. 

### STEP 2:
The system will be able to move to the Right, Left, Up, Down, and Suck, depending on the percepts.

### STEP 3:
Developing the PEAS description:
<br />Agent Type:Vaccum Cleaner
...
### STEP 4:
The agent should detect the location of the robot and suck if the location it is dirty,else it should move to the next location.
### STEP 5:
...
class TrivialVacuumEnvironment(Environment):
    ...
    def clean_check(self):
        ...
        for key in [loc_A, loc_B, loc_C, loc_D, loc_E, loc_F, loc_G, loc_H, loc_I]:
...
if __name__ == "__main__":
    ...
    print("\nNumber of Clean rooms ",environment.clean_check())
    environment.run(steps=6)
    print('\n\nAfter Action\n\n',environment.status)
    print('\nAgent Location',agent.location)
    print('\n\nAgent Performance',agent.performance)
    print("Number of Clean rooms ",environment.clean_check())
